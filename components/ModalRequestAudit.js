      ...
      <Dialog as="div" className="relative z-10" initialFocus={cancelButtonRef} onClose={setOpen}>
        ...
        <div className="fixed inset-0 z-10 overflow-y-auto">
          <div className="flex min-h-full items-end items-center justify-center p-0 p-4 text-center">
            ...
            >
              <div className="flex flex-col place-items-center rounded-xl bg-gray-50 px-10 py-3 sm:px-40">
                <div className="mb-6 mt-1 text-base font-semibold leading-6 text-gray-900">
                  Request an audit 🕵️
                </div>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="rounded-md bg-black px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-red-500 "
                >
                  DM me on 𝕏
                </a>
              </div>
